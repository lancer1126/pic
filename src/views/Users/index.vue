...
import AuthorIllusts from "@/views/Users/components/AuthorIllusts";
import FavoriteIllusts from "@/views/Users/components/FavoriteIllusts";
import api from '@/api'

export default {
  name: 'Users',
  components: {FavoriteIllusts, AuthorIllusts, TopBar},
  data() {
    return {
      loading: false,
      userInfo: {},
  ...
  watch: {
    $route() {
      ...
      if (this.$route.name === 'Users' && this.$route.params.id !== this.userInfo.id) {
        this.init()
      }
    }
  },
